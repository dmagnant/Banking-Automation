...
def runTIAA(directory, driver):
    ...
    ## Login 
    # driver.find_element_by_id("password").send_keys(getPassword(directory, 'TIAA'))   # password pre-filled
    time.sleep(1)
    # click LOG IN
    ...
    tiaa = driver.find_element_by_xpath("//*[@id='hero-balance']/div[1]/div[2]").text.strip('$').replace(',','')
    return tiaa