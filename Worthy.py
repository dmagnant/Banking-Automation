...
def runWorthy(directory, driver):    
    ...
    wpc1_raw = driver.find_element(By.XPATH, "/html/body/div[1]/div/div[1]/main/div/div/div[2]/div/div[2]/div/div/div[3]/div/h4/span[3]").text.strip('$').replace(',','')
    ...
    wpc2_raw = driver.find_element(By.XPATH, "/html/body/div[1]/div/div[1]/main/div/div/div[2]/div/div[3]/div/div/div[2]/div/h4/span[3]").text.strip('$').replace(',','')
